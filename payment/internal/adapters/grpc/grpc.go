...
import (
	"context"
	"fmt"
	"github.com/Manikiran744/microservices-proto/golang/payment"
	"github.com/Manikiran744/microservices/payment/internal/application/core/domain"
...
func (a Adapter) Create(ctx context.Context, request *payment.CreatePaymentRequest) (*payment.CreatePaymentResponse, error) {
	...
	return &payment.CreatePaymentResponse{PaymentId: result.ID}, fmt.Errorf("CUSTOM ERROR")
}